...
4. APIで駅の現在の天気・気温を取得して配布、index.html,judge.pyの修正（担当：Haruhisa222 https://github.com/Haruhisa222）
5. HTML,CSSでメイン画面を設計,APIと天気アイコン連結（担当：kazuki404313 https://github.com/kazuki404313）